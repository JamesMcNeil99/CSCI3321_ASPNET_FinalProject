...
namespace CSCI3321_ASPNET_FinalProject
{
    public partial class MyBooks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Select * From Books INNER JOIN Genres ON Books.GenreID = Genres.GenreID INNER JOIN Authors ON Books.AuthorID = AUthors.AuthorID INNER JOIN Publishers ON Books.PublisherID = Publishers.PublisherID; ";
